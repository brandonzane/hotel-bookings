...
const style = {
  header: `sticky top-0 z-50 grid grid-cols-3 bg-white p-5 shadow-md md:px-10`,
  logoContainer: `relative my-auto flex h-10 cursor-pointer items-center`,
  searchWrapper: `flex items-center rounded-full py-2 md:border-2 md:shadow-lg`,
  ...
  globeAltIcon: `h-6 cursor-pointer hover:animate-spin sm-hidden`,
}
